            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative border-l border-dark/20 dark:border-white/20 ml-4 md:ml-12 pl-8 md:pl-16 space-y-12">
                    ...
                    {Array.isArray(experience) && experience.map((item, index) => (
                        ...
                        >
                            {/* Timeline Dot */}
                            <div className="absolute top-2 -left-[41px] md:-left-[73px] w-4 h-4 rounded-full bg-purple-500 border-4 border-white dark:border-zinc-900 z-10" />
                            ...
                            <div className="w-full">
                                ...
                                <ul className="list-disc list-outside ml-5 space-y-2 text-secondary dark:text-gray-400">
